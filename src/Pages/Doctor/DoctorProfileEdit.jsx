...
const DoctorProfileEdit = () => {
  ...
  // ✅ Fetch logged-in doctor profile on component mount
  useEffect(() => {
    const fetchDoctorProfile = async () => {
      try {
        ...
        const doctor = res.data.data; // ✅ Corrected from res.data.doctor
        setFormData({
          _id: doctor._id || "",
          ...
          photoUrl: doctor.photoUrl || "", // ✅ Matches correct casing
        });
      } catch (err) {
