...
// //       const updated = { ...filteredData, updatedAt: new Date().toISOString() };
...
// //   return (
// //     <div className="max-w-4xl px-6 py-10 mx-auto bg-white shadow-md rounded-xl">
...
// //             type="submit"
// //             disabled={loading}
// //             className="w-full py-3 font-semibold text-white transition bg-teal-600 rounded-md hover:bg-teal-700"
// //           >
...
//   return (
//     <div className="grid max-w-6xl grid-cols-1 gap-8 p-6 mx-auto mt-8 bg-white shadow-md md:grid-cols-2 rounded-xl">
//       {/* Form Section */}
//       <div>
...
//                 value={formData[name] || ""}
//                 onChange={handleChange}
//                 className="w-full px-4 py-2 border rounded-md shadow-sm focus:ring-2 focus:ring-teal-500 focus:outline-none"
...
//             type="submit"
//             disabled={loading}
//             className="w-full py-3 mt-2 font-semibold text-white transition bg-teal-600 rounded-md hover:bg-teal-700"
//           >
//             {loading ? "Updating..." : "Update Profile"}
//           </button>
//         </form>
...
//             />
//           ) : (
//             <div className="flex items-center justify-center w-32 h-32 text-lg text-white bg-gray-400 rounded-full shadow">
//               No Photo
//             </div>
//           )}
//         </div>
