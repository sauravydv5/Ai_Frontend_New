  ...
  return (
    <div className="flex flex-col w-full h-full px-4 py-6 bg-gradient-to-tr from-orange-100 via-green-100 to-sky-100">
      <div className="relative flex flex-col w-full h-full max-w-3xl p-6 mx-auto bg-white border border-gray-200 shadow-xl rounded-3xl">
        ...
        <h2 className="mt-10 mb-1 text-2xl font-bold text-center text-green-700">
          Swāsthya AI
        </h2>
        ...
        {/* Disclaimer */}
        <div className="px-4 py-2 mb-4 text-xs text-center text-yellow-800 bg-yellow-100 border border-yellow-300 rounded-md">
          ⚠️ This is an AI-based chatbot. Its answers may not be medically
          accurate. Please consult a qualified doctor for proper diagnosis and
          treatment.
        </div>
          ...
          {loading && !botTyping && (
            <div className="flex items-start gap-2">
              <div className="flex items-center gap-2 text-sm font-medium text-green-600 animate-pulse">
                ...
                Swāsthya AI is preparing a response...
              </div>
            </div>
          )}
