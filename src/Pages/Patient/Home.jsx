    ...
    <div className="w-full px-6 py-10 bg-gray-50 min-h-[90vh]">
      ...
      <div className="grid grid-cols-1 gap-6 mb-10 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div
            key={i}
            className={`bg-gradient-to-br ${card.color} p-5 rounded-2xl shadow-md hover:shadow-xl transition`}
          >
      ...
      {/* Banner */}
      <div className="flex flex-col items-center justify-between px-6 py-6 mb-10 border border-green-200 shadow lg:flex-row bg-gradient-to-r from-green-100 to-blue-50 rounded-3xl">
        <div className="max-w-xl">
          <h2 className="mb-2 text-2xl font-semibold text-green-800">
            🌿 Stay Healthy, Stay Happy
          </h2>
          <p className="mb-4 text-gray-700">
            Don’t forget to drink water, eat well, and take short walks!
          </p>
      ...
      {appointment ? (
        <div className="p-6 mb-8 bg-white border shadow-md rounded-2xl">
      ...
      {/* Health Reminder */}
      <div className="p-6 text-yellow-900 bg-yellow-100 border border-yellow-300 shadow-inner rounded-2xl">
